    ...
    return (
        <div className='profileDetailContainer'>
            ...
            <div className="information">
                ...
                <div>
                    <span>Your Role (Artist/Buyer Level)</span>
                    <label>
                        <select value={role} onChange={(e) => setRole(e.target.value)} style={{ padding: '1rem', border: '1px solid #b2beb5', width: '100%', borderRadius: '4px', background: 'white', fontSize: '1.4rem' }}>
                            <option value="user">Buyer / Regular User</option>
                            <option value="painter">Painter (Art Upload Privileges)</option>
                            <option value="sketcher">Sketcher (Art Upload Privileges)</option>
                            <option value="sculptor">Sculptor (Art Upload Privileges)</option>
                            <option value="photographer">Photographer (Art Upload Privileges)</option>
