    ...
    return (
        <div className="aboutContainer">
            <div className="aboutBanner" style={aboutStyle}>
                <h1>About Us</h1>
                <p>
                “MetArt: Metaphysical Art Market” is a web application platform with an
            ...
            <div className="missions">
                ...
                <p>
                Our mission is to bridge the gap between talented artists and art lovers across the entire Indian market using a seamless online platform.
                </p>
                <br/>
